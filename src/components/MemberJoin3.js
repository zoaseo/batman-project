...
//                             <td className="join_right">
//                             <input className='margin' type="text" name="name" value={formData.name} onChange={onChange}/>
//                             </td>
//                         </tr>
//                         <tr>
...
//                             <td className="join_right">
//                                 <input className='margin' name="add" type="text" value={formData.add} onChange={onChange}/>
